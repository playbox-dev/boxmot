...
def create_tracker(tracker_type, tracker_config=None, reid_weights=None, device=None, half=None, per_class=None, evolve_param_dict=None):
    ...
    tracker_mapping = {
        ...
        'botsort_gsr': 'boxmot.trackers.botsort_gsr.botsort_gsr.BotSort_gsr'
    }
    ...
    if tracker_type in ['strongsort', 'botsort', 'botsort_gsr', 'deepocsort', 'hybridsort', 'imprassoc', 'boosttrack']:
